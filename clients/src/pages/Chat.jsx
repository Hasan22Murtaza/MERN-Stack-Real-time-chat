        ...
        activeChat ?
          <div className={props.className}>
            ...
            <div className='absolute left-[5%] bottom-[8%]'>
              ...
              <div className='border-[1px] border-[#aabac8] px-6 py-3 w-[730px] sm:w-[730px] md:w-[430px] h-[50px] lg:w-[730px] rounded-t-[10px]'>
              ...
              <div className='border-x-[1px] border-b-[1px] bg-[#f8f9fa] border-[#aabac8] px-6 py-3 w-[360px] sm:w-[400px] md:w-[350px] lg:w-[730px] rounded-b-[10px] h-[50px]'>
                {/* {
